...
{
    public class YOLOv8Seg : YOLO
    {
        public YOLOv8Seg(string model_path, string device, int categ_nums, float det_thresh, float det_nms_thresh, int input_size)
            : base(model_path, device, categ_nums, det_thresh, det_nms_thresh, new int[] { 1, 3, input_size, input_size },
            new List<string> { "images" }, new List<int[]> { new int[] { 1, 36 + categ_nums, 8400 } , new int[] { 1, 32, 25600 } }, new List<string> { "output0", "output1" })
        {
        }
